...
def makeRFSfilters(radius=24, sigmas=[1, 2, 4], n_orientations=6):
    ...
    # bar = np.asarray(bar).reshape(len(sigmas), n_orientations, support, support)
...
def get_responses(img, sigmas=[1, 2, 4], n_orientations=6):
    n_sigmas = len(sigmas)
    ...
    return apply_filterbank(img, filterbank)
...
if __name__ == "__main__":
    ...
    img_path = "C:\\Work\\research\\shadow_removal\\experiments\\test_images_real\\real157_shad.png"
